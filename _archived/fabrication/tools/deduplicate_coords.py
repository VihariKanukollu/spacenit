"""Prune duplicate longitude/latitude pairs that already exist in datasets."""
...
def remove_duplicate_lonlats(
    ...
    Args:
        ...
        ds_paths: the existing rslearn dataset paths for SpaceNit dataset creation.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Remove duplicate lon/lat coordinates",
    )
    parser.add_argument(
        "--ds_path",
        type=str,
    ...
    parser.add_argument(
        "--in_fname",
        type=str,
        help="Input JSON filename containing list of [lon, lat]",
        required=True,
    )
    parser.add_argument(
        "--out_fname",
