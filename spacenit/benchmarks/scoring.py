...
class BenchmarkTaskResult:
    """Result from a benchmark task (knn, linear probe, finetune)."""

    val_result: BenchmarkResult | None
    test_result: BenchmarkResult | None
...
class BenchmarkResult:
    ...
    def from_classification(
        ...
        """Create BenchmarkResult from classification metrics.
    ...
    def from_segmentation(
        ...
        """Create BenchmarkResult from segmentation metrics."""
        return cls(
            primary=miou,
            metrics={
                "miou": miou,
...
def segmentation_metrics(
    ...
    return BenchmarkResult.from_segmentation(
        miou=miou,
        overall_acc=overall_acc,
        macro_acc=macro_acc,
        macro_f1=macro_f1,
