"""Shared normalization functions for benchmark datasets."""
...
from .constants import BENCH_S2_BAND_NAMES
...
def impute_normalization_stats(
    ...
    all_bands: list[str] = BENCH_S2_BAND_NAMES,
) -> dict:
    """For certain benchmark datasets, the normalization stats (band_info) may be incomplete.
