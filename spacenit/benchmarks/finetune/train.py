...
from spacenit.benchmarks.finetune.checkpoint_utils import (
    load_training_checkpoint,
    save_training_checkpoint,
)
from spacenit.benchmarks.finetune.constants import (
...
from spacenit.benchmarks.finetune.evaluate import eval_cls, eval_seg
from spacenit.benchmarks.finetune.model import (
    BackboneWithHead,
...
def compute_benchmark_metrics(
    ft: nn.Module,
    task_config: BenchmarkDatasetConfig,
    ...
    return BenchmarkTaskResult(val_result=val_result, test_result=test_result)
...
def run_finetune_benchmark(
    ...
    best_val_result: BenchmarkResult | None = None
    start_epoch = 0
