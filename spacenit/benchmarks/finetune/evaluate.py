...
from spacenit.benchmarks.finetune.model import BackboneWithHead, to_device
from spacenit.benchmarks.scoring import BenchmarkResult, segmentation_metrics
...
def eval_cls(
    ...
    Returns:
        BenchmarkResult with metrics: micro f1 (if multilabel) or accuracy.
    """
    module.eval()
    ...
    if is_multilabel:
        ...
        return BenchmarkResult.from_classification(acc, f1=f1)
    else:
...
def eval_seg(
    ...
    Returns:
        BenchmarkResult with metrics: miou, overall_acc, macro_acc, macro_f1
    """
    module.eval()
