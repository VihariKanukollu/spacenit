"""Training utilities for the SpaceNit pipeline."""
...
def partition_masked_batch(
    ...
    # Build microbatches
    return [
        MaskedGeoSample(**{f: chunks[i] for f, chunks in splits.items()})
